    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'dashboards', children: [
                ...
                {path: 'wms360', loadChildren: () => import('app/modules/admin/dashboards/wms360/wms360.module').then(m => m.Wms360Module)},
            ...
            {path: 'apps', children: [
                ...
                {path: 'contracts', loadChildren: () => import('app/modules/admin/apps/contracts/contracts.module').then(m => m.ContractsModule)},
